# MiniMax China Mainland Model and Metadata Sync

Use this workflow when the task requires current model, endpoint, capability, lifecycle, alias, role, or pricing verification for **MiniMax China Mainland direct API**.
...
Do not use MiniMax International documentation, International endpoints or prices, Anthropic-compatible surfaces, third-party wrappers, forum posts, or screenshots as factual proof.
