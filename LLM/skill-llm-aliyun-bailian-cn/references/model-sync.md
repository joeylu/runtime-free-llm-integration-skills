# Aliyun Bailian China Mainland Model and Metadata Sync

Use this workflow when the task requires current model, endpoint, capability, lifecycle, alias, role, or pricing verification for **Aliyun Bailian / Model Studio China Mainland**.
...
Use official Aliyun China Mainland Model Studio documentation only.

Preferred entry points:

- Model catalog: `https://help.aliyun.com/zh/model-studio/models`
- Model pricing: `https://help.aliyun.com/zh/model-studio/model-pricing`
- API reference index: `https://help.aliyun.com/zh/model-studio/developer-reference/api-reference`

Do not use Alibaba Cloud International documentation, International/Singapore endpoints or prices, third-party wrappers, forum posts, screenshots, or repo comments as factual proof.
...
1. Define the provider, region `china-mainland`, request kinds, surfaces, API versions, and pricing scopes in the task.
