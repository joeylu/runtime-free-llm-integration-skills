# DeepSeek Model and Metadata Sync

Use this workflow when the task requires current model, endpoint, capability, lifecycle, alias, role, or pricing verification for **DeepSeek direct API**.
...
Use official DeepSeek API documentation only.
...
- Agent compatibility example: `https://api-docs.deepseek.com/quick_start/agent_integrations/oh_my_pi/`
- Change log: `https://api-docs.deepseek.com/updates/`

Do not use third-party OpenAI-compatible wrappers, SDK enums, forum posts, screenshots, or observed request errors as factual proof.
