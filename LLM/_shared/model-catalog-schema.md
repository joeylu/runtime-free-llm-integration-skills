...
| Column | Meaning |
| --- | --- |
| `Model Type` | compatibility request kind: `chat`, `vision`, `imaging`, or `music` |
| `Operation` | `text-generation`, `multimodal-understanding`, `image-generation`, or `music-generation` |
