# Alibaba Cloud Model Studio International Model and Metadata Sync

Use this workflow when the task requires current model, endpoint, capability, lifecycle, alias, role, or pricing verification for **Alibaba Cloud Model Studio International**.
...
Use official Alibaba Cloud International Model Studio documentation only.

Preferred entry points:

- Model pricing: `https://www.alibabacloud.com/help/en/model-studio/model-pricing`
- Model lifecycle: `https://www.alibabacloud.com/help/en/model-studio/model-depreciation`
...
Do not use China Mainland endpoints or prices, third-party wrappers, forum posts, screenshots, or repo comments as factual proof.
