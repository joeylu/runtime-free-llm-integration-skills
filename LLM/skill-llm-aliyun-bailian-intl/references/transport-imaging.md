...
This International skill does not bundle selected imaging rows yet. Keep imaging blocked until `model-catalog.md`, `request-urls.md`, and `capability-matrix.md` all verify the exact International path.
