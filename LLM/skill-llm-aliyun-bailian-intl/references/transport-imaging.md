...
This International skill does not bundle documented imaging rows yet. Keep imaging blocked until `model-catalog.md`, `request-urls.md`, and `capability-matrix.md` all verify the exact International path.
